  ...
  return (
    <Layout title="Workouts">
      <div className="bg-blue-primary text-white py-8">
        <h2 className="font-judul text-4xl text-center tracking-wide">CIRCUIT</h2>
      ...
      <div className="my-4 text-blue-primary">
        <div className="max-h-fit overflow-hidden">
          <img src="/image/workouts/Weight_loss.jpg" alt="Circuit" className="mx-auto h-full w-full max-w-5xl -mb-10 object-cover object-bottom" />
        </div>
        <div className="max-w-3xl mx-auto text-center my-4">
          <h2 className="font-judul text-4xl mb-4">CIRCUIT</h2>
      ...
      <div className="my-8 mb-12 bg-neutral-100 text-blue-primary text-center place-items-center grid lg:grid-cols-2">
        ...
        <div>
          <img src="/image/workouts/detail_kelas/Circuit_1.jpg" alt="Circuit" className="h-full w-full object-cover object-center" />
        </div>
      </div>
    </Layout>
  )
